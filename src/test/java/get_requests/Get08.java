...
public class Get08 extends JsonPlaceHolderBaseUrl {
    ...
    public void get08() {
        ...
        //d"si 5 den küçük olan tüm kullanıcıların "userid"lerini yazdırın
        ...
        List<String> userIdTitle = json.getList("findAll{it.id<5}.title");
        System.out.println("userIdTitle = " + userIdTitle);
